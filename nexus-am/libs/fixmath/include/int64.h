...
static inline fixmath_int64_t int64_const(int32_t hi, uint32_t lo) { return (fixmath_int64_t){ hi, lo }; }
static inline fixmath_int64_t int64_from_int32(int32_t x) { return (fixmath_int64_t){ (x < 0 ? -1 : 0), x }; }
static inline   int32_t int64_hi(fixmath_int64_t x) { return x.hi; }
static inline  uint32_t int64_lo(fixmath_int64_t x) { return x.lo; }

static inline int int64_cmp_eq(fixmath_int64_t x, fixmath_int64_t y) { return ((x.hi == y.hi) && (x.lo == y.lo)); }
static inline int int64_cmp_ne(fixmath_int64_t x, fixmath_int64_t y) { return ((x.hi != y.hi) || (x.lo != y.lo)); }
static inline int int64_cmp_gt(fixmath_int64_t x, fixmath_int64_t y) { return ((x.hi > y.hi) || ((x.hi == y.hi) && (x.lo >  y.lo))); }
static inline int int64_cmp_ge(fixmath_int64_t x, fixmath_int64_t y) { return ((x.hi > y.hi) || ((x.hi == y.hi) && (x.lo >= y.lo))); }
static inline int int64_cmp_lt(fixmath_int64_t x, fixmath_int64_t y) { return ((x.hi < y.hi) || ((x.hi == y.hi) && (x.lo <  y.lo))); }
static inline int int64_cmp_le(fixmath_int64_t x, fixmath_int64_t y) { return ((x.hi < y.hi) || ((x.hi == y.hi) && (x.lo <= y.lo))); }

static inline fixmath_int64_t int64_add(fixmath_int64_t x, fixmath_int64_t y) {
	fixmath_int64_t ret;
	ret.hi = x.hi + y.hi;
	ret.lo = x.lo + y.lo;
...
static inline fixmath_int64_t int64_neg(fixmath_int64_t x) {
	fixmath_int64_t ret;
	ret.hi = ~x.hi;
	ret.lo = ~x.lo + 1;
	if(ret.lo == 0)
...
static inline fixmath_int64_t int64_sub(fixmath_int64_t x, fixmath_int64_t y) {
	return int64_add(x, int64_neg(y));
}

static inline fixmath_int64_t int64_shift(fixmath_int64_t x, int8_t y) {
	fixmath_int64_t ret;
	if(y > 0) {
		if(y >= 32)
			return (fixmath_int64_t){ 0, 0 };
...
static inline fixmath_int64_t int64_mul_i32_i32(int32_t x, int32_t y) {
	...
	return (fixmath_int64_t){ r_hi, r_lo };
}

static inline fixmath_int64_t int64_mul_i64_i32(fixmath_int64_t x, int32_t y) {
	int neg = ((x.hi ^ y) < 0);
	if(x.hi < 0)
		x = int64_neg(x);
	if(y < 0)
...
static inline fixmath_int64_t int64_div_i64_i32(fixmath_int64_t x, int32_t y) {
	int neg = ((x.hi ^ y) < 0);
	if(x.hi < 0)
		x = int64_neg(x);
	if(y < 0)
	...
	fixmath_int64_t ret = { (x.hi / y) , (x.lo / y) };
	x.hi = x.hi % y;
	x.lo = x.lo % y;

	fixmath_int64_t _y = int64_from_int32(y);
...
#define int64_t fixmath_int64_t
